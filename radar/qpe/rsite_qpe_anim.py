    ...
    for frad in fhrad:
        if frad[1] is not np.nan:
            ...
            # =============================================================================
                ...
                if 'r_zopt' in rprods:
                    rzh_fit = tpx.rzh_opt(
                        ...
                        # minpia=(5 if resattc.site_name == 'Juxpol' else 5),
            ...
            # =============================================================================
                ...
                rad_georef['grid_rectx'] = resattc.georef['grid_rectx']
                rad_georef['grid_recty'] = resattc.georef['grid_recty']
                # rad_georef['grid_wgs84x'] = resattc.georef['grid_wgs84x']
                # rad_georef['grid_wgs84y'] = resattc.georef['grid_wgs84y']
                gif_params.append(resattc.params)
                ...
                for nv in vars2plot:
                    if nv in r_vars_all:
                        r_vars_all[nv].append(resattc.vars[nv])
