...
rdata.ppi_xpol(scan_elev=SCAN_ELEVS.get('el_06'), rawdata_type=True)
...
clmap = np.loadtxt(CLM_DIR+f'{RADAR_SITE.lower()}'
                   ...
                   + '_cluttermap_el0.dat')
clmap = None
# Despeckle and removal of lr_coeffsinear signatures
...
rnme.clutter_id(rdata.georef, rdata.params, rnme.vars, binary_class=143,
...
rmlyr.ml_top = 3.533652644296308
rmlyr.ml_bottom = 2.443073957621891
...
# =============================================================================
# att_alphax = [0.28, 0.4, 0.3]  # Light to moderate rain
# att_alphax = [0.35, 0.6, 0.5]  # Moderate to heavy rain
...
# rd_qcatc.vars['Rainfall [mm/h]'] = rqpe.r_z['Rainfall [mm/h]']
# rd_qcatc.vars['Rainfall [mm/h]'] = rqpe.r_zfit['Rainfall [mm/h]']
